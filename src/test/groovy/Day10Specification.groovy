...
....."""
        ...
        expect:
        pipeMaze.getNextDirection(2, 1, 'D' as Character) == 'D'
    }

    def "get next direction 2"() {
        given:
        String input = """.....
.S-7.
.|.|.
...
....."""
        ...
        expect:
        pipeMaze.getNextDirection(3, 1, 'D' as Character) == 'R'
    }

    def "get steps to furthest point 1"() {
        given:
        String input = """.....
.S-7.
.|.|.
...
....."""
        ...
        expect:
        pipeMaze.getStepsToFurthestPoint() == 4
    }

    def "get steps to furthest point 2"() {
        given:
        String input = """-L|F7
7S-7|
L|7||
...
L|-JF"""
    ...
    def "get steps to furthest point 3"() {
        given:
        String input = """..F7.
.FJ|.
SJ.L7
...
LJ..."""
        ...
        expect:
        pipeMaze.getStepsToFurthestPoint() == 8
    }

    def "get steps to furthest point 4"() {
        given:
        String input = """..F7.
.FJ|.
SJ.L7
...
LJ..."""
    ...
    def "get steps to furthest point 5"() {
        given:
        String input = """.-FL-L777F-F.7-LJF-7.F|7F7.FF---7-F-L|-F-JJ-LL.J-F7.L-LJFF-LFFJ7.FF-F|FFFJ77-F-LF|--7-FL.JJ.F-F7|--F77|JJFLF-|-F-F-7-7-77F-7FF.FF7F7F--|.7.F
