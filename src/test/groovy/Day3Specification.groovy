...
class Day3Specification extends Specification {
    ...
    def "get the total sum 1"() {
        given:
        String input = """........897.......839...........651.399.............236...............................343...986...........308...............................
........*................*404......*............134.....953..508=.....................*....*..........325*..........744......392............
...350..847..403...-..541.....622.................*....................356.......%..95...793....................830...........*.....163....."""

        expect:
        Day3Gondola.getSum(input) == 7623
    }

    def "get the total sum 2"() {
        given:
        String input = """...444.......84...#....+..........527......*351..............*......*................225..888.......806.............7......#...518.....*....
.............*........628...............749......*976.200.....852..354...23....=........*...............................138............833..
..........964.................................211...............................578.....986.............879......59........................."""

        expect:
        Day3Gondola.getSum(input) == 7929
    }

    def "get the total sum 3"() {
        given:
...
.664.598.."""
        ...
        expect:
        Day3Gondola.getSum(input) == 4361
    }

    def "get the total sum 4"() {
        given:
        String input = """...444.......84...#....+..........527......*351..............*......*................225..888.......806.............7......#...518.....*....
.............*........628...............749......*976.200.....852..354...23....=........*...............................138............833..
..........964.................................211...............................578.....986.............879......59........................."""
...
.664.598.."""
        ...
        !Day3Gondola.isValid(0, 0, lines)
    }

    def "check if pos valid false"() {
        given:
        String input = """467..114..
...*......
..35..633.
...
.664.598.."""
        ...
        expect:
        List<String> lines = input.split('\n')
        !Day3Gondola.isValid(6, 8, lines)
    }

    def "check if pos valid true 1"() {
        given:
        String input = """467..114..
...*......
..35..633.
...
.664.598.."""
        ...
        expect:
        List<String> lines = input.split('\n')
        Day3Gondola.isValid(9, 2, lines)
    }

    def "check if pos valid true 2"() {
        given:
        String input = """467..114..
...*......
..35..633.
...
.664.598.."""
        ...
        expect:
        List<String> lines = input.split('\n')
        Day3Gondola.isValid(0, 3, lines)
    }

    def "check if pos valid true 3"() {
        given:
        String input = """........897.......839...........651.399.............236...............................343...986...........308...............................
........*................/404......*............134.....953..508%.....................*....*..........325*..........744......392............
...350..847..403...-..541.....622.................*....................356.......%..95...793....................830...........*.....163....."""
        ...
        expect:
        List<String> lines = input.split('\n')
        Day3Gondola.isValid(1, 65, lines)
    }

    def "check if pos valid true 4"() {
        given:
        String input = """467..114..
...*......
..35..633.
